...
Module Info.
  ...
  Definition source_file := "max.c"%string.
...
Definition _b : ident := 54%positive.
Definition _c : ident := 55%positive.
Definition _d : ident := 56%positive.
Definition _main : ident := 59%positive.
Definition _max3 : ident := 57%positive.
Definition _min : ident := 58%positive.
...
Definition f_max3 := {|
  ...
  fn_params := ((_a, tint) :: (_b, tint) :: (_c, tint) :: nil);
  fn_vars := nil;
  fn_temps := ((_d, tint) :: (_t'2, tint) :: (_t'1, tint) :: nil);
  fn_body :=
(Ssequence
  (Ssequence
    (Sifthenelse (Ebinop Olt (Etempvar _a tint) (Etempvar _b tint) tint)
      (Sset _t'1 (Ecast (Etempvar _b tint) tint))
      (Sset _t'1 (Ecast (Etempvar _a tint) tint)))
    (Sset _d (Etempvar _t'1 tint)))
  (Ssequence
    (Sifthenelse (Ebinop Olt (Etempvar _d tint) (Etempvar _c tint) tint)
      (Sset _t'2 (Ecast (Etempvar _c tint) tint))
      (Sset _t'2 (Ecast (Etempvar _d tint) tint)))
...
(Ssequence
  (Sifthenelse (Ebinop Olt (Etempvar _a tint) (Etempvar _b tint) tint)
    (Sset _t'1 (Ecast (Etempvar _b tint) tint))
    (Sset _t'1 (Ecast (Etempvar _a tint) tint)))
  (Sifthenelse (Ebinop Oeq (Etempvar _a tint) (Etempvar _t'1 tint) tint)
    (Sreturn (Some (Etempvar _b tint)))
    (Sreturn (Some (Etempvar _a tint)))))
|}.
...
(Ssequence
  (Ssequence
    (Scall (Some _t'1)
      (Evar _max3 (Tfunction (Tcons tint (Tcons tint (Tcons tint Tnil))) tint
                    cc_default))
      ((Econst_int (Int.repr 3) tint) :: (Econst_int (Int.repr 5) tint) ::
...
((___builtin_ais_annot,
 ...
 (___builtin_debug,
   Gfun(External (EF_external "__builtin_debug"
     ...
     {|cc_vararg:=true; cc_unproto:=false; cc_structret:=false|})) ::
 (_max3, Gfun(Internal f_max3)) :: (_min, Gfun(Internal f_min)) ::
 (_main, Gfun(Internal f_main)) :: nil).

Definition public_idents : list ident :=
(_main :: _min :: _max3 :: ___builtin_debug :: ___builtin_write32_reversed ::
