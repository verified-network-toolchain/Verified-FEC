...
Module Info.
  ...
  Definition source_file := "arr2d.c"%string.
...
Definition _arr : ident := 53%positive.
Definition _i : ident := 55%positive.
Definition _ith : ident := 57%positive.
Definition _main : ident := 58%positive.
Definition _n : ident := 56%positive.
Definition _ptr : ident := 54%positive.
Definition _t'1 : ident := 59%positive.

Definition v_arr := {|
  gvar_info := (tarray (tarray tint 4) 3);
...
Definition f_ith := {|
  ...
  fn_params := ((_ptr, (tptr tint)) :: (_i, tint) :: (_n, tint) :: nil);
  fn_vars := nil;
...
(Ssequence
  (Sset _t'1
    (Ederef
      (Ebinop Oadd (Etempvar _ptr (tptr tint)) (Etempvar _i tint)
        (tptr tint)) tint))
  ...
  (Ssequence
    (Sassign
      (Ederef
        (Ebinop Oadd
          (Ederef
            (Ebinop Oadd (Evar _arr (tarray (tarray tint 4) 3))
    ...
    (Ssequence
      (Scall (Some _t'1)
        (Evar _ith (Tfunction
                     (Tcons (tptr tint) (Tcons tint (Tcons tint Tnil))) tint
                     cc_default))
        ((Ecast (Evar _arr (tarray (tarray tint 4) 3)) (tptr tint)) ::
         (Econst_int (Int.repr 6) tint) :: (Econst_int (Int.repr 12) tint) ::
         nil))
      (Sreturn (Some (Etempvar _t'1 tint)))))
...
((___builtin_ais_annot,
 ...
 (___builtin_debug,
   Gfun(External (EF_external "__builtin_debug"
     ...
     {|cc_vararg:=true; cc_unproto:=false; cc_structret:=false|})) ::
 (_arr, Gvar v_arr) :: (_ith, Gfun(Internal f_ith)) ::
 (_main, Gfun(Internal f_main)) :: nil).

Definition public_idents : list ident :=
(_main :: _ith :: _arr :: ___builtin_debug :: ___builtin_write32_reversed ::
